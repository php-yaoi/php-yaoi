...
class Database_Driver_PdoPgsql extends Database_Driver {
    /** @var  PDO */
    private $connection;
    ...
    public function lastInsertId()
    {
        ...
        if (!$res) {
            throw new Database_Exception(implode(' ', $this->connection->errorInfo()),
                Database_Exception::QUERY_ERROR);
        }
    ...
    public function rewind($result)
    {
        if (!empty($result->rewinded)) {
            ...
            throw new Database_Exception('Can not rewind query result', Database_Exception::REWIND_NOT_SUPPORTED);
        }
    }
