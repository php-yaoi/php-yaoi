...
namespace Yaoi\Debug;
use View_HTML_Element;

/**
 * Class Debug_CollapsiblePrintR
 * @method static CollapsiblePrintR create($var)
 */
class CollapsiblePrintR extends View_HTML_Element
{
    protected $tag = 'pre';
        ...
        <script type="text/javascript">(function (e) {
                ...
                function i(e, t) {
                    ...
                    if (!t) {
                        ...
                        for (var r = 0; r < e.childNodes.length; ++r) {
                            if ("debug-data" == e.childNodes[r].className) {
                                n = i(e.childNodes[r], t - 1);
                                if (-1 != n) {
                                    return n
                                }
                            }
                ...
                function s(e, t, n) {
                    ...
                    for (var o = 0; o < e.childNodes.length; ++o) {
                        if ("debug-data" == e.childNodes[o].className) {
                            r(e.childNodes[o], n);
                            if (t) {
                                s(e.childNodes[o], true, n)
                            }
                        }
                    }
                    if (n) {
                ...
                function o(e) {
                    ...
                    for (var i = 0; i < t.length; ++i) {
                        t[i].onclick = function () {
                            var e = this.className, t = this.parentNode.nextSibling;
                            if (e == "toggle-display") {
                                r(t)
                            } else if (e == "toggle-children") {
                                s(t, false)
                            } else if (e == "toggle-recursive") {
                                s(t, true)
                            }
                            return false
                        }
                ...
                if ("undefined" == typeof e) {
                    ...
                    e = t[t.length - 1].previousSibling
                }
                o(e)
            })()</script>
    <?php
